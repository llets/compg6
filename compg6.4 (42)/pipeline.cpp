...
const glm::mat4& Pipeline::GetVPTrans()
{
	...
	m_VPtransformation = m_Vtransformation * m_ProjTransformation;
...
const glm::mat4& Pipeline::GetWorldTrans()
{
	...
	m_Wtransformation = ScaleTrans * RotateTrans * TranslationTrans;
...
const glm::mat4& Pipeline::GetWVPTrans()
{
	...
	m_WVPtransformation = m_Wtransformation * m_VPtransformation;
...
const glm::mat4& Pipeline::GetWVOrthoPTrans()
{
	...
	m_WVPtransformation = m_Wtransformation * m_Vtransformation * P;
	return m_WVPtransformation;
}
...
const glm::mat4& Pipeline::GetWPTrans()
{
	...
	m_WPtransformation = m_Wtransformation * PersProjTrans;
